...
def main():
    ...
    lines = ["// AUTO-GENERATED by backend/scripts/gen_audio.py — do not edit by hand. Music only (SFX removed by owner choice).", "/* eslint-disable @typescript-eslint/no-require-imports */", "export const AUDIO: Record<string, number> = {"]
    for p in files:
